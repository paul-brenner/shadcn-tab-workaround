...
import type { FlatColumn } from './columns';
import { TableComponent } from './tableComponent';
import type { AnyPlugins } from './types/TablePlugin';
export declare type BodyRowInit<Item, Plugins extends AnyPlugins = AnyPlugins> = {
    id: string;
...
export declare type BodyRowAttributes<Item, Plugins extends AnyPlugins = AnyPlugins> = {
    role: 'row';
};
...
declare type BodyRowCloneProps = {
    includeCells?: boolean;
    includeSubRows?: boolean;
};
export declare type DataBodyRowInit<Item, Plugins extends AnyPlugins = AnyPlugins> = BodyRowInit<Item, Plugins> & {
    dataId: string;
    original: Item;
};
...
export declare type DisplayBodyRowInit<Item, Plugins extends AnyPlugins = AnyPlugins> = BodyRowInit<Item, Plugins>;
