...
export declare type HeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = {
    id: string;
    label: HeaderLabel<Item, Plugins>;
    colspan: number;
    colstart: number;
};
export declare type HeaderCellAttributes<Item, Plugins extends AnyPlugins = AnyPlugins> = {
    role: 'columnheader';
    colspan: number;
};
...
export declare type FlatHeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = Omit<HeaderCellInit<Item, Plugins>, 'colspan'>;
export declare type FlatHeaderCellAttributes<Item, Plugins extends AnyPlugins = AnyPlugins> = HeaderCellAttributes<Item, Plugins>;
...
export declare type DataHeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = FlatHeaderCellInit<Item, Plugins> & {
...
export declare type FlatDisplayHeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = Omit<FlatHeaderCellInit<Item, Plugins>, 'label'> & {
    label?: HeaderLabel<Item, Plugins>;
};
...
export declare type GroupHeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = Omit<HeaderCellInit<Item, Plugins>, 'id'> & {
    ids: string[];
    allIds: string[];
};
...
export declare type GroupDisplayHeaderCellInit<Item, Plugins extends AnyPlugins = AnyPlugins> = Omit<GroupHeaderCellInit<Item, Plugins>, 'label' | 'colspan'> & {
    label?: HeaderLabel<Item, Plugins>;
    colspan?: number;
};
